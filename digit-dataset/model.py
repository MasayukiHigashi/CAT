...
class LeNetModel(object):
    ...
    def g(self, x, training=False):
        ...
        #fc1 = fc(flattened, NUM_IN, NUM_OUT, bn=False, training=training, name='fc1')
        fc1 = fc(flattened, NUM_IN, NUM_OUT, bn=False, training=training, name='fc1')
        fc2 = fc(fc1, NUM_OUT, self.num_classes, relu=False,bn=False, training=training, name='fc2')
        return fc2

    def f(self, fc2, training=False):
        # fc1 = fc(flattened, NUM_IN, NUM_OUT, bn=False, training=training, name='fc1')
        # fc2 = fc(fc1, NUM_OUT, 10, relu=False,bn=False, training=training, name='fc2')
        return fc2
    ...
    def inference(self, x, training=False):
        ...
        fc1 = fc(flattened, NUM_IN, NUM_OUT, bn=False,name='fc1')
        fc2 = fc(fc1, NUM_OUT, self.num_classes, relu=False,bn=False,name='fc2')
        self.fc1=fc1
        self.fc2=fc2
        self.score=fc2
